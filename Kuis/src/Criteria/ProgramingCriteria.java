 ...
 */
public class ProgramingCriteria extends input implements job{

    public ProgramingCriteria(String nama, double nilai1, double nilai2, double nilai3) {
    ...
    public double hitungNilaiTotal() {
       return (0.6 * super.nilai1) + (0.15 * super.nilai2) + (0.25 * super.nilai3);
    }
